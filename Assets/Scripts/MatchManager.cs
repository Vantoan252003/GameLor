...
public class MatchManager : MonoBehaviourPunCallbacks, IOnEventCallback
{
    ...
    public void UpdateStatsDisplay()
    {
        ...
        {
            UIController.instance.killsText.text = $"Giết: {allPlayers[index].kills}";
            UIController.instance.deathsText.text = $"Chết: {allPlayers[index].death}";
        }
        else
        {
            UIController.instance.killsText.text = "Giết: 0}";
            UIController.instance.deathsText.text = "Chết: 0}";
        }
    }
